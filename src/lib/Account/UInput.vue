<template>
  <div class="u-input-wrap" :class="'u-input-wrap-' + size">
    <span class="u-input-prefix" v-if="prefix"><i class="usoft-iconfont" :class="prefix ? prefix : ''"></i></span>
    <input
      :type="type"
      ref="comInput"
    ...
    <div class="append-icon cursor-default">
      <i class="usoft-iconfont icon-close clear" v-if="clearable" @click.prevent="clear"></i>
...
export default {
  ...
  emits: ['update:value', 'keyup', 'input', 'blur', 'adderBlur'],
  props: {
    type: {
      type: String,
      default: 'text'
